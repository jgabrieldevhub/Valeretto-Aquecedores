...
<html lang="pt-br">
    <?php
        $page_title = "Nossa História - Valeretto";
...
<body>
    ...
    <main>
        ...
        <?php
            $valeretto_info = [
                ['./uploads/Valeretto_empresario.jpg','Valeretto','Fundador e Proprietário','“Seja qual for o projeto é muito gratificante ver a satisfação de um cliente e saber que atendemos suas expectativas, melhorando o seu conforto através de uma proposta mais eficiente e sustentável”'],
                ['./uploads/Sandra_Valeretto_empresaria.jpg','Sandra','Fundadora e Proprietária','“Somos gratos por todos que nos ajudaram nessa jornada. Aprendemos muito e evoluímos, mas a sua essência e valores continuam assegurando sua qualidade e confiabilidade”'],
            ];
        ?>
